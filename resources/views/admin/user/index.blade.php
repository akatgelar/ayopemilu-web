    ...
    <script>
        $('#datatable').DataTable( {
            ...
            ajax: function(data, callback, settings) {
                ...
                function(json) {
                    callback({
                        recordsTotal: json.pagination.total_data,
                        recordsFiltered: json.pagination.total_data,
                        data: json.data
                    });
                });
            },
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        return type === 'display'
                            ? '<img src="{{ asset("/") }}uploads/' + data + '" style="max-width:100px; max-height:100px;">'
                            : data;
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: function (data, type, row, meta) {
                        ...
                        var btn_edit = `
                            <a href="{{ url("/admin/user/`+data+`/edit") }}" class="btn btn-sm btn-icon btn-warning flex-end" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit">
                                <span class="btn-inner">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

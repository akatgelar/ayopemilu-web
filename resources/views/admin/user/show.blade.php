            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            ...
                            <div style="display: flex;">
                                <a href="{{ url("/admin/user/".$id."/edit") }}" class="btn btn-sm btn-icon btn-warning flex-end" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit">
                    ...
                    <div class="card-body" id="detail-data-success" style="display: none;">
                        ...
                        <div class="mt-2">
                            <h6 class="mb-1">Election</h6>
                            <p id="election_name"></p>
                        </div>
                        <div class="mt-2">
        ...
        $.ajax({
            ...
            success: function (result) {
                if(result['status'] == true) {
                    ...
                    $('#role_name').html(result['data']['role']['name']);
                    $('#election_name').html(result['data']['election']['category'] + ' - ' + result['data']['election']['area']);
                    $('#email').html(result['data']['email']);
                    $('#name').html(result['data']['name']);
                    $("#picture").attr("src", "{{ url('/') }}/uploads/" + result['data']['picture']);
                    $('#gender').html(result['data']['gender']);
                    $('#bod').html(convertStringToDate(result['data']['bod']));
                    ...
                    if(result['data']['status'] == '1') {
                        ...
                        $('#status').html('<span class="badge bg-danger">Not Active</span>');
                    }

...
use App\Models\AreaKecamatan;
use App\Http\Resources\ApiResource;

class AreaKecamatanController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/api/area_kecamatan",
     *     tags={"AreaKecamatan"},
     *     summary="",
     *     description="Get all data",
     *     operationId="area_kecamatan_index",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="per_page",
    ...
    public function index(Request $request)
    {
        ...
        // query get
        $query = AreaKecamatan::where([['id','>','0']]);
    ...
    /**
     * @OA\Get(
     *     path="/api/area_kecamatan/{id}",
     *     tags={"AreaKecamatan"},
     *     summary="",
     *     description="Get data by id",
     *     operationId="area_kecamatan_show",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
     ...
     *     operationId="area_kecamatan_store",
     *     security={{"bearerAuth":{}}},
     *     @OA\RequestBody(
     *          @OA\MediaType(
     *              mediaType="application/json",
    ...
    public function store(Request $request)
    {
        ...
        // query insert
        $query = AreaKecamatan::create($datas);
     ...
     *     operationId="area_kecamatan_update",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
    ...
    public function update(Request $request, $id)
    {
        ...
        // query insert
        $query = AreaKecamatan::findOrFail($id);
     ...
     *     operationId="area_kecamatan_destroy",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",

...
class AreaKelurahanController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/api/area_kelurahan",
     *     tags={"AreaKelurahan"},
     *     summary="",
     *     description="Get all data",
     *     operationId="area_kelurahan_index",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="per_page",
    ...
    public function index(Request $request)
    {
        ...
        // query get
        $query = AreaKelurahan::where([['id','>','0']]);
        ...
        if($search){
            $query = $query->where(function ($query) use ($search){
                $query->where('kemendagri_provinsi_kode', 'ILIKE', '%'.$search.'%')
                    ...
                    ->orWhere('kemendagri_kecamatan_kode', 'ILIKE', '%'.$search.'%')
                    ->orWhere('kemendagri_kecamatan_nama', 'ILIKE', '%'.$search.'%')
                    ->orWhere('kemendagri_kelurahan_kode', 'ILIKE', '%'.$search.'%')
                    ->orWhere('kemendagri_kelurahan_nama', 'ILIKE', '%'.$search.'%');
            });
        }
    ...
    /**
     * @OA\Get(
     *     path="/api/area_kelurahan/{id}",
     *     tags={"AreaKelurahan"},
     *     summary="",
     *     description="Get data by id",
     *     operationId="area_kelurahan_show",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
     ...
     *     operationId="area_kelurahan_store",
     *     security={{"bearerAuth":{}}},
     *     @OA\RequestBody(
     *          @OA\MediaType(
     *              mediaType="application/json",
    ...
    public function store(Request $request)
    {
        ...
        // query insert
        $query = AreaKelurahan::create($datas);
     ...
     *     operationId="area_kelurahan_update",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
    ...
    public function update(Request $request, $id)
    {
        ...
        // query insert
        $query = AreaKelurahan::findOrFail($id);
     ...
     *     operationId="area_kelurahan_destroy",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",

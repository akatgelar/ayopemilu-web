...
use App\Models\AreaProvinsi;
use App\Http\Resources\ApiResource;

class AreaProvinsiController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/api/area_provinsi",
     *     tags={"AreaProvinsi"},
     *     summary="",
     *     description="Get all data",
     *     operationId="area_provinsi_index",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="per_page",
    ...
    /**
     * @OA\Get(
     *     path="/api/area_provinsi/{id}",
     *     tags={"AreaProvinsi"},
     *     summary="",
     *     description="Get data by id",
     *     operationId="area_provinsi_show",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
     ...
     *     operationId="area_provinsi_store",
     *     security={{"bearerAuth":{}}},
     *     @OA\RequestBody(
     *          @OA\MediaType(
     *              mediaType="application/json",
    ...
    public function store(Request $request)
    {
        ...
        // query insert
        $query = AreaProvinsi::create($datas);
     ...
     *     operationId="area_provinsi_update",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
    ...
    public function update(Request $request, $id)
    {
        ...
        // query insert
        $query = AreaProvinsi::findOrFail($id);
     ...
     *     operationId="area_provinsi_destroy",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",

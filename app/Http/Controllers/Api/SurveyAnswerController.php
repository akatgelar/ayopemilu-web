...
class SurveyAnswerController extends Controller
{
     ...
     *     operationId="survey_answer_index",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="per_page",
    ...
    public function index(Request $request)
    {
        ...
        if($search){
            $query = $query->where(function ($query) use ($search){
                $query->where('answer', 'ILIKE', '%'.$search.'%');
            });
        }
     ...
     *     operationId="survey_answer_show",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
     ...
     *     operationId="survey_answer_store",
     *     security={{"bearerAuth":{}}},
     *     @OA\RequestBody(
     *          @OA\MediaType(
     *              mediaType="application/json",
    ...
    public function store(Request $request)
    {
        ...
        // query insert
        $query = SurveyAnswer::create($datas);
     ...
     *     operationId="survey_answer_update",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
    ...
    public function update(Request $request, $id)
    {
        ...
        // query insert
        $query = SurveyAnswer::findOrFail($id);
     ...
     *     operationId="survey_answer_destroy",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",

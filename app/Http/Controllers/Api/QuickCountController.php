...
class QuickCountController extends Controller
{
    ...
    /**
     * @OA\Get(
     *     path="/api/quick_count",
     *     tags={"QuickCount"},
     *     summary="",
     *     description="Get all data",
     *     operationId="quick_count_index",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="per_page",
    ...
    /**
     * @OA\Get(
     *     path="/api/quick_count/{id}",
     *     tags={"QuickCount"},
     *     summary="",
     *     description="Get data by id",
     *     operationId="quick_count_show",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
     ...
     *     operationId="quick_count_update",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
    ...
    public function update(Request $request, $id)
    {
        ...
        // query insert
        $query = QuickCount::findOrFail($id);
     ...
     *     operationId="quick_count_destroy",
     *     security={{"bearerAuth":{}}},
     *     @OA\Parameter(
     *          name="id",
     *          description="id",
